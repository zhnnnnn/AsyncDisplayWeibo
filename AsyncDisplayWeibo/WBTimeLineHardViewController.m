//
//  WBTimeLineHardViewController.m
//  AsyncDisplayWeibo
//
...
@interface WBTimeLineHardViewController ()<ASTableDelegate,ASTableDataSource>
@property (nonatomic,strong) ASTableNode *tableNode;
@property (nonatomic,strong) NSMutableArray <WBStatusLayout *> *layoutArray;
@end

@implementation WBTimeLineHardViewController
...
- (ASCellNode *)tableNode:(ASTableNode *)tableNode nodeForRowAtIndexPath:(NSIndexPath *)indexPath {
    WBTimeLineHardCell *hardNode = [[WBTimeLineHardCell alloc]init];
